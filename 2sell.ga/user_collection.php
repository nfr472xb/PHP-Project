        ...
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <?php
                        ...
                        // 顯示欄位名稱 不顯示管理員帳號資料
                        $sql = "  SELECT  * FROM product,collection WHERE product_id=collection_product &&collection_account= '$users_account'";
                       ...
                       echo "
                       <form action='single.php?product_id=$row[0]' method='post' class='form login' >
                       <div class='form__field'>
                      <input type='submit'  value='了解詳情'></input>
                       </div>
                    </form>
                       <form action='user_collection_delete.php' method='post' class='form login' >
                       <div class='form__field'>
