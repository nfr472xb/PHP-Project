...
if ( isset($_POST["add_money"]) )
{
    ...
    if ($add_money != null){
      ...
      if ($add_money>=1&&$add_money<=10000) {
    $add_money = $old_money+$add_money;
    $now =  $add_money;
    $sql = "UPDATE users SET users_money = '$add_money'
...
<html lang="en">
  ...
  <body>
    ...
    <div class="read-it">
    此頁面由於金流串接的困難，僅模擬使用者輸入購物金後進行加值功能
    </div>
        </div>  </div>
...
echo "$dd";
 ...
 ?>
            ...
            <form action="user-money.php" method="post" class="form login">
  <div class="add_money"  >

              <div >
                  <input  id="login__password" type="text" name="add_money"  placeholder="1~10000" >
              </div>
  </br>
              <div >
                <input  id="login__password" type="submit" value="儲值">
              </div>
