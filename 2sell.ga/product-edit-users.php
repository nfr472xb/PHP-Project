...
可重新上傳圖片
        ...
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            ...
            // 顯示欄位名稱 不顯示管理員帳號資料
            $sql = "SELECT * FROM product where product_account='$users_account' ";
...
echo "      <form action='product-edit-users.php' method='post' class='form login'  enctype='multipart/form-data' >
...
<input name='product_account'  value='$row[1]'style='width: 0px;' />
    ...
    <div class='form__field'>
            ...
            <form action='product-delete.php' method='post' class='form login' >
            <div class='form__field'>
