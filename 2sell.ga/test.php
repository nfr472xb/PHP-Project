 ...
 for ($i=0; $i <7 ; $i++) {
  ...
  ?>
    <div class="read-it" style="width:50%;">
      <canvas id="a_analytics" width="10" height="10"></canvas>
    </div>
  ...
  <canvas id="myChart" width="10" height="10"></canvas>
    ...
    new Chart(document.getElementById("pie-chart"), {
        ...
        data: {
          ...
          datasets: [{
            label: "分類的瀏覽次數",
            backgroundColor: ["#ffdb4d", "#79ff4d","#ff5c33","#66ccff","#d966ff","#c2c2a3","#0066ff"],
            data: [
    ...
    new Chart(document.getElementById("a_analytics"), {
        type: 'pie',
        data: {
          labels: ["3C", "衣服", "其他", "書", "鞋子", "衣服", "交通工具"],
          datasets: [{
